          ...
          <Card className="">
            <CardContent className="p-4">
              <div className="w-full flex flex-col justify-start items-center px-4 gap-4">
                ...
                <div className="flex flex-col justify-start items-start w-full gap-2 px-2 text-lg text-justify">
                  <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex incidunt consequuntur soluta praesentium nobis quis ut nihil, cupiditate deleniti dignissimos impedit dicta mollitia harum, iure corporis aspernatur quidem accusamus! Perspiciatis?</p>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid perferendis earum, nam asperiores neque tempora illum laboriosam officia minima recusandae!</p>
                  <p>Option 3</p>
                  <p>Option 4</p>
                </div>
